...
import com.ammar.walletconnectlibadd.server.BridgeServer
...
//                "https://bridge.walletconnect.org",
            ...
            session = WCSession(
                config,
                    ...
                    Session.PeerMeta(url="https://your's_website_url",name = "Example App",description = "demp app",icons = arrayListOf())
            )
            session.offer()
        }
    }
